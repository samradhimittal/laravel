            ...
            <div class="card">
                ...
                <div class="alert alert-danger print-error-msg" style="display:none">
                    ...
                    <form action="javascript:void(0)" id="UserForm" name="InterestForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">Select Hobbies</label>

                            <div class="col-md-6">
                                @foreach($interests as $key => $interest)
                                <input type="checkbox" name="interests[]" value="{{$interest->id}}">{{$interest->name}}
                                @endforeach
                            </div>
